...
export function registerTools(
  ...
  server.registerTool("git_commit_amend", TOOL_CATALOG.git_commit_amend, (input, context) =>
    invoke(context, active, (signal, report) => service.git_commit_amend(input, signal, report)));
